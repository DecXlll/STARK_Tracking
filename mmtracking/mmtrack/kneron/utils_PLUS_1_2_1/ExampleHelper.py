...
from .ExampleEnum import *

import re
import os
import sys
# sys.path.append(r'c:\users\shaoxuan\appdata\local\programs\python\python36\lib\site-packages')
# sys.path.append(r'c:\users\shaoxuan\appdata\roaming\python\python36\site-packages')
import cv2
