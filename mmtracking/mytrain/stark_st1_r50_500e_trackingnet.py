...
data = dict(
    ...
    train=dict(
        ...
        dataset_cfgs=[
            dict(
                type='GOT10kDataset',
                ann_file='data/got10k/annotations/got10k_train_infos.txt',
                img_prefix='data/got10k',
                pipeline=[
                    dict(
                        type='TridentSampling',
                        num_search_frames=1,
            ...
            dict(
                type='LaSOTDataset',
                ann_file='data/lasot/annotations/lasot_train_infos.txt',
            ...
            dict(
                ...
                ann_file=
                'data/trackingnet/annotations/trackingnet_train_infos.txt',
                img_prefix='data/trackingnet',
                pipeline=[
                    dict(
                        type='TridentSampling',
                        num_search_frames=1,
    ...
    val=dict(
        type='GOT10kDataset',
        ann_file='data/got10k/annotations/got10k_test_infos.txt',
        img_prefix='data/got10k',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True, with_label=False),
    ...
    test=dict(
        type='TrackingNetDataset',
        ann_file='data/trackingnet/annotations/trackingnet_test_infos.txt',
        img_prefix='data/trackingnet',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True, with_label=False),
